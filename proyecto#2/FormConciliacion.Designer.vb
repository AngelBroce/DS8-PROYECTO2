...
Partial Class FormConciliacion
    ...
    Private Sub InitializeComponent()
        ...
        MenuStrip1.Size = New Size(727, 27)
        ...
        GroupBox1.Size = New Size(668, 504)
        ...
        Label18.Location = New Point(40, 384)
        ...
        lblsaldoconciliadoigualabanco.Location = New Point(40, 458)
        lblsaldoconciliadoigualabanco.Name = "lblsaldoconciliadoigualabanco"
        lblsaldoconciliadoigualabanco.Size = New Size(227, 15)
        ...
        lblsaldoenbancoal.Size = New Size(138, 15)
        ...
        lblsaldoconciliadosegunlibros.Location = New Point(40, 282)
        lblsaldoconciliadosegunlibros.Name = "lblsaldoconciliadosegunlibros"
        lblsaldoconciliadosegunlibros.Size = New Size(231, 15)
        ...
        ' 
        txtsaldoconciliadosegun.Location = New Point(387, 279)
        txtsaldoconciliadosegun.Name = "txtsaldoconciliadosegun"
        txtsaldoconciliadosegun.ReadOnly = True
        txtsaldoconciliadosegun.Size = New Size(106, 23)
        ...
        ' txtsaldoenbanco
        ' 
        txtsaldoenbanco.Location = New Point(387, 324)
        txtsaldoenbanco.Name = "txtsaldoenbanco"
        txtsaldoenbanco.Size = New Size(106, 23)
        txtsaldoenbanco.TabIndex = 11
        ' 
        ' txtresta1
        ' 
        txtresta1.Location = New Point(387, 250)
        txtresta1.Name = "txtresta1"
        txtresta1.ReadOnly = True
        txtresta1.Size = New Size(106, 23)
        txtresta1.TabIndex = 10
        ' 
        ' txtchequesgirados
        ' 
        txtchequesgirados.Location = New Point(280, 221)
        txtchequesgirados.Name = "txtchequesgirados"
        txtchequesgirados.ReadOnly = True
        txtchequesgirados.Size = New Size(106, 23)
        txtchequesgirados.TabIndex = 9
        ' 
        ' txtsubtotal
        ' 
        txtsubtotal.Location = New Point(387, 192)
        ...
        ' txtsuma
        ' 
        txtsuma.Location = New Point(387, 163)
        txtsuma.Name = "txtsuma"
        txtsuma.ReadOnly = True
        txtsuma.Size = New Size(106, 23)
        txtsuma.TabIndex = 7
        ' 
        ' txtxhequesanulados
        ' 
        txtxhequesanulados.Location = New Point(280, 134)
        txtxhequesanulados.Name = "txtxhequesanulados"
        txtxhequesanulados.ReadOnly = True
        txtxhequesanulados.Size = New Size(106, 23)
        txtxhequesanulados.TabIndex = 6
        ' 
        ' txtdepositos
        ' 
        txtdepositos.Location = New Point(280, 105)
        txtdepositos.Name = "txtdepositos"
        txtdepositos.ReadOnly = True
        txtdepositos.Size = New Size(106, 23)
        txtdepositos.TabIndex = 5
        ' 
        ' txtsaldosegun
        ' 
        txtsaldosegun.Location = New Point(387, 76)
        txtsaldosegun.Name = "txtsaldosegun"
        txtsaldosegun.ReadOnly = True
        txtsaldosegun.Size = New Size(106, 23)
        ...
        lblsaldosegunlibro.Size = New Size(151, 15)
        ...
        lblcorrespondientealmes.Size = New Size(151, 15)
